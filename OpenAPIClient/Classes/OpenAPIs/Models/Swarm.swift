...
public struct Swarm: Codable, JSONEncodable, Hashable {
    ...
    public init(ID: String? = nil, version: ObjectVersion? = nil, createdAt: String? = nil, updatedAt: String? = nil, spec: SwarmSpec? = nil, tLSInfo: TLSInfo? = nil, rootRotationInProgress: Bool? = nil, dataPathPort: Int? = nil, defaultAddrPool: [String]? = nil, subnetSize: Int? = nil, joinTokens: JoinTokens? = nil) {
        self.ID = ID
